...
- Create Angular project with ng: `ng new 29-9-2024.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`29-9-2024.client.esproj`).
- Create `launch.json` to enable debugging.
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `29-9-2024.client.esproj`).
